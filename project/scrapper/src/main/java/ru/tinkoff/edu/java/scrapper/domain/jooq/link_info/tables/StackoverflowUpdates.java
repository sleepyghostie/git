...
public class StackoverflowUpdates extends TableImpl<StackoverflowUpdatesRecord> {
     ...
     */
    public final TableField<StackoverflowUpdatesRecord, Long> ID =
     ...
     */
    public final TableField<StackoverflowUpdatesRecord, Boolean> IS_ANSWERED = createField(DSL.name("IS_ANSWERED"),
     ...
     */
    public final TableField<StackoverflowUpdatesRecord, Integer> ANSWER_COUNT = createField(DSL.name("ANSWER_COUNT"),
    ...
    public <U> SelectField<U> mapping(
            Class<U> toType,
            Function3<? super Long, ? super Boolean, ? super Integer, ? extends U> from
    ) {
