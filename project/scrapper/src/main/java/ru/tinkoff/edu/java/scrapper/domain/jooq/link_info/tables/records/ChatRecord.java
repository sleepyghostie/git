package project.scrapper.src.main.java.ru.tinkoff.edu.java.scrapper.domain.jooq.link_info.tables.records;
...
public class ChatRecord extends UpdatableRecordImpl<ChatRecord> implements Record1<Long> {
     ...
     * Create a detached, initialised ChatRecord
     */
    public ChatRecord(ru.tinkoff.edu.java.scrapper.domain.jooq.link_info.tables.pojos.Chat value) {
        super(Chat.CHAT);
