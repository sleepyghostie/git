...
public class GithubUpdates extends TableImpl<GithubUpdatesRecord> {
     ...
     */
    public final TableField<GithubUpdatesRecord, Long> ID =
            createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>LINK_INFO.GITHUB_UPDATES.FORKS_COUNT</code>.
     */
    public final TableField<GithubUpdatesRecord, Integer> FORKS_COUNT = createField(DSL.name("FORKS_COUNT"),
     ...
     */
    public final TableField<GithubUpdatesRecord, Integer> WATCHERS = createField(DSL.name("WATCHERS"),
            SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)),
            this,
            ""
    );
