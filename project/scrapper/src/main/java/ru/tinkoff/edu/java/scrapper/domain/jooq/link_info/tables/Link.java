package project.scrapper.src.main.java.ru.tinkoff.edu.java.scrapper.domain.jooq.link_info.tables;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    public final TableField<LinkRecord, String> URL =
            createField(DSL.name("URL"), SQLDataType.VARCHAR(512).nullable(false), this, "");
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"),
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_CHECK = createField(DSL.name("LAST_CHECK"),
            SQLDataType.LOCALDATETIME(6).nullable(false)
                    .defaultValue(DSL.field(DSL.raw("'1970-01-01 00:00:00'"), SQLDataType.LOCALDATETIME)),
            this,
            ""
    ...
    public <U> SelectField<U> mapping(
            Class<U> toType,
            Function6<? super Long, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? extends U> from
    ) {
