package project.scrapper.src.main.java.ru.tinkoff.edu.java.scrapper.domain.jooq.link_info;
/*
...
public class Keys {
    ...
    public static final UniqueKey<GithubUpdatesRecord> CONSTRAINT_D =
            Internal.createUniqueKey(GithubUpdates.GITHUB_UPDATES,
                    DSL.name("CONSTRAINT_D"),
                    new TableField[] {GithubUpdates.GITHUB_UPDATES.ID},
                    true
            );
    ...
    public static final UniqueKey<StackoverflowUpdatesRecord> CONSTRAINT_3 = Internal.createUniqueKey(
            StackoverflowUpdates.STACKOVERFLOW_UPDATES,
            DSL.name("CONSTRAINT_3"),
            new TableField[] {StackoverflowUpdates.STACKOVERFLOW_UPDATES.ID},
            true
    );
    ...
    public static final ForeignKey<GithubUpdatesRecord, LinkRecord> CONSTRAINT_DE = Internal.createForeignKey(
            GithubUpdates.GITHUB_UPDATES,
            DSL.name("CONSTRAINT_DE"),
            new TableField[] {GithubUpdates.GITHUB_UPDATES.ID},
            Keys.CONSTRAINT_2,
            new TableField[] {Link.LINK.ID},
            true
    );
    public static final ForeignKey<LinkRecord, ChatRecord> CONSTRAINT_23A = Internal.createForeignKey(Link.LINK,
            DSL.name("CONSTRAINT_23A"),
            new TableField[] {Link.LINK.CHAT_ID},
            Keys.CONSTRAINT_1,
            new TableField[] {Chat.CHAT.CHAT_ID},
            true
    );
    public static final ForeignKey<StackoverflowUpdatesRecord, LinkRecord> CONSTRAINT_33 = Internal.createForeignKey(
            StackoverflowUpdates.STACKOVERFLOW_UPDATES,
            DSL.name("CONSTRAINT_33"),
            new TableField[] {StackoverflowUpdates.STACKOVERFLOW_UPDATES.ID},
            Keys.CONSTRAINT_2,
            new TableField[] {Link.LINK.ID},
            true
